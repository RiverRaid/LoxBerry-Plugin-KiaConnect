...
$commands = <<<'XML'
	...
	<VirtualInUdpCmd Title="Full" Comment="{{COMMENT_FULL}}" Address="" Check="FULL=\v" Signed="true" Analog="true" SourceValLow="0" DestValLow="0" SourceValHigh="1" DestValHigh="1" DefVal="0" MinVal="0" MaxVal="1" Unit="&lt;v&gt;" HintText="" Documentation="Triggers if the battery is charged to 100% for more than 3 hours"/>
	<VirtualInUdpCmd Title="Fullparked" Comment="{{COMMENT_FULLPARKED}}" Address="" Check="FULLPARKED=\v" Signed="true" Analog="true" SourceValLow="0" DestValLow="0" SourceValHigh="1" DestValHigh="1" DefVal="0" MinVal="0" MaxVal="1" Unit="&lt;v&gt;" HintText="" Documentation="Triggers if the battery is charged to 100% for more than 3 hours and the charging plug is still connected"/>
	<VirtualInUdpCmd Title="Recharge100" Comment="{{COMMENT_RECHARGE100}}" Address="" Check="RECHARGE100=\v" Signed="true" Analog="true" SourceValLow="0" DestValLow="0" SourceValHigh="1" DestValHigh="1" DefVal="0" MinVal="0" MaxVal="1" Unit="&lt;v&gt;" HintText="" Documentation="Triggers if not fully charged for 30 days"/>
	<VirtualInUdpCmd Title="Lowbattery" Comment="{{COMMENT_LOWBATTERY}}" Address="" Check="LOWBATTERY=\v" Signed="true" Analog="true" SourceValLow="0" DestValLow="0" SourceValHigh="1" DestValHigh="1" DefVal="0" MinVal="0" MaxVal="1" Unit="&lt;v&gt;" HintText="" Documentation="Triggers if the battery is below 10% and not charging for more than 3 hours"/>
XML;
